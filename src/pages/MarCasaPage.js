...
export default function MarCasaPage() {
      ...
      <main className="flex-1 pb-12 bg-white">
        ...
        <section className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden">
          <div
            ...
            style={{ backgroundImage: 'url("/deyaar/Mar Casa/image-3-1.jpg")' }}
          />
          <div className="absolute inset-0 bg-black bg-opacity-40 z-10" />
          <div className="relative z-20 w-full flex flex-col items-center justify-center text-center px-4">
            <h1 className="text-4xl md:text-6xl font-light mb-4 text-white font-sans tracking-tight" style={{fontFamily: 'Roboto, sans-serif'}}>MAR CASA</h1>
        ...
        <section className="max-w-6xl mx-auto py-20 px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-700 leading-relaxed max-w-4xl mx-auto font-sans" style={{fontFamily: 'Roboto, sans-serif'}}>
              Mar Casa by Deyaar offers modern, well-designed residences in the vibrant Al Furjan community. With a focus on quality construction, contemporary design, and excellent amenities, Mar Casa provides the perfect blend of comfort, convenience, and investment potential. Experience urban living at its finest with thoughtfully designed spaces and world-class facilities.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-6 font-sans" style={{fontFamily: 'Roboto, sans-serif'}}>
                  Mar Casa represents modern living with a focus on quality, comfort, and community. Each residence is thoughtfully designed to maximize space and functionality while providing residents with access to world-class amenities and facilities. The development features contemporary architecture with premium finishes and smart home technologies.
                </p>
              ...
              <div className="relative">
                <img
                  src="/deyaar/Mar Casa/Rectangle-143-2-scaled.jpg"
                  alt="Mar Casa Project"
        ...
        <section className="max-w-6xl mx-auto py-20 px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              <img
                src="/deyaar/Mar Casa/Rectangle-15-2-2.jpg"
                alt="Mar Casa Location"
                className="w-full h-96 object-cover rounded-lg shadow-lg"
              />
            </div>
            <div>
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-6 font-sans" style={{fontFamily: 'Roboto, sans-serif'}}>
                Strategically located in Al Furjan, Mar Casa offers excellent connectivity to major highways, shopping centers, schools, and healthcare facilities. The area is rapidly developing with new infrastructure and amenities, making it an ideal location for families and investors alike.
              </p>
        ...
        <section className="max-w-6xl mx-auto py-20 px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-6 font-sans" style={{fontFamily: 'Roboto, sans-serif'}}>
                Every detail in Mar Casa has been carefully considered to create spaces that are both beautiful and functional. From the premium finishes to the smart home technologies, residents will enjoy a lifestyle of comfort and convenience. The interiors feature modern design elements with high-quality materials throughout.
              </p>
              <div className="space-y-4">
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-black rounded-full mr-3"></div>
            ...
            <div className="relative">
              <img
                src="/deyaar/Mar Casa/Rectangle-15-4-2.jpg"
                alt="Mar Casa Interior"
                className="w-full h-96 object-cover rounded-lg shadow-lg"
              />
            </div>
          </div>
        ...
        <section className="bg-gray-50 py-20">
          <div className="max-w-6xl mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-light text-gray-900 mb-12 text-center tracking-tight" style={{fontFamily: 'Roboto, sans-serif'}}>Why Choose Mar Casa</h2>
        ...
        <section className="bg-gray-50 py-20">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="relative">
                <img
                  src="/deyaar/Mar Casa/Rectangle-15-8.jpg"
                  alt="Mar Casa Exterior"
                  className="w-full h-64 object-cover rounded-lg shadow-lg"
                />
              </div>
              <div className="relative">
                <img
                  src="/deyaar/Mar Casa/Rectangle-23-2.jpg"
                  alt="Mar Casa Amenities"
                  className="w-full h-64 object-cover rounded-lg shadow-lg"
                />
              </div>
              <div className="relative">
                <img
                  src="/deyaar/Mar Casa/Rectangle-144-2.jpg"
                  alt="Mar Casa Lifestyle"
                  className="w-full h-64 object-cover rounded-lg shadow-lg"
                />
              </div>
            </div>
